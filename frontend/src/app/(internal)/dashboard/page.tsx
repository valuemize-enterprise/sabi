      ...
      {loading ? (
        ...
        <>
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
            <StatCard label="Total Brands"    value={data?.totalBrands ?? 0}    icon={Building2}  color="purple" />
            <StatCard label="Active Staff"    value={data?.totalStaff ?? 0}     icon={Users}      color="blue"   />
            <StatCard label="Active Goals"    value={data?.activeGoals ?? 0}    icon={Target}     color="green"  />
            <StatCard label="Reports Published"value={data?.totalReports ?? 0} icon={FileText}   color="amber"  />
          </div>
