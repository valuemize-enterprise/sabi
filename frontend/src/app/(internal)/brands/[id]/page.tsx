...
const SUB_PAGES = [
  ...
  { href: 'social-reports',label: 'Social Media Reports',icon: BarChart2,     desc: 'Platform reports', color: 'pink'    },
  ...
  { href: 'financials',    label: 'Financials',          icon: Wallet,        desc: 'Invoices & spend', color: 'lime'    },
  { href: 'settings',      label: 'Settings',            icon: Brain,         desc: 'Brand config',     color: 'red'     },
  { href: 'reports',       label: 'Reports',             icon: PieChart,      desc: 'Analytics data',   color: 'orange'  },
...
const ICON_COLORS: Record<string, string> = {
  ...
  indigo:  'text-indigo-400 bg-indigo-500/10 border-indigo-500/15 group-hover:bg-indigo-500/20',
  ...
  lime:    'text-lime-400 bg-lime-500/10 border-lime-500/15 group-hover:bg-lime-500/20',
