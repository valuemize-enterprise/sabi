...
interface TopNavProps {
  title?:    string;
  subtitle?: string;
  /** Optional breadcrumb items shown before the title */
    ...
    <header className="h-14 flex items-center justify-between mb-6">
      ...
      <div className="flex items-center gap-3 flex-shrink-0">
        <Link href="/notifications"
          ...
          {/* Unread dot — always show, real count wired later */}
...
// All pages that import `AgencyTopNav` keep working with no changes
