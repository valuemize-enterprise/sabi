...
const PERMISSIONS = {
  ...
  CREATE_STAFF:         [ROLES.SUPER_ADMIN, ROLES.CEO, ROLES.MANAGING_DIRECTOR, ROLES.ACCOUNT_DIRECTOR, ROLES.HUMAN_RESOURCE],
  VIEW_ALL_STAFF:       [ROLES.SUPER_ADMIN, ROLES.CEO, ROLES.MANAGING_DIRECTOR, ROLES.ACCOUNT_DIRECTOR, ROLES.CREATIVE_DIRECTOR, ROLES.STRATEGY_DIRECTOR, ROLES.HUMAN_RESOURCE ],
  ...
  VIEW_ALL_BRANDS:      [ROLES.SUPER_ADMIN, ROLES.CEO, ROLES.MANAGING_DIRECTOR, ROLES.ACCOUNT_DIRECTOR, ROLES.HUMAN_RESOURCE],
  ...
  // Goals
  CREATE_GOAL:          [ROLES.SUPER_ADMIN, ROLES.ACCOUNT_MANAGER, ROLES.SENIOR_STRATEGIST, ROLES.STRATEGIST, ROLES.BRAND_ADMIN],
  EDIT_GOAL:            [ROLES.SUPER_ADMIN, ROLES.ACCOUNT_MANAGER, ROLES.SENIOR_STRATEGIST, ROLES.STRATEGIST],

  // ARIA
  USE_ARIA:             AGENCY_ROLES.concat([ROLES.SUPER_ADMIN, ROLES.HUMAN_RESOURCE]),
  ...
  VIEW_AUDIT_LOGS:      [ROLES.SUPER_ADMIN, ROLES.CEO, ROLES.MANAGING_DIRECTOR, ROLES.HUMAN_RESOURCE],
};
